...
"https://github.com/sshleifer/Graph-WaveNet/blob/master/model.py"
...
class GWNet(nn.Module):
    def __init__(self,
                 # device,
                 num_nodes, dropout=0.3, supports=None, do_graph_conv=True,
        ...
        if do_graph_conv and addaptadj:
            ...
            self.nodevec1, self.nodevec2 = [Parameter(n, requires_grad=True) for n in nodevecs]
