...
from AD_repository.model.baseline.layers.Embed import DataEmbedding, DataEmbedding_wo_pos,DataEmbedding_wo_pos_temp,DataEmbedding_wo_temp
from AD_repository.model.baseline.layers.AutoCorrelation import AutoCorrelation, AutoCorrelationLayer
from AD_repository.model.baseline.layers.Autoformer_EncDec import Encoder, Decoder, EncoderLayer, DecoderLayer, my_Layernorm, series_decomp
import math
import numpy as np
...
class Autoformer_4ours(nn.Module):
    ...
    def forward(self, X, T, T_of_y, Y):
        ...
        "开始Encoder和Decoder"
        x = self.Autoformer(x_enc, x_mark_enc, x_dec, x_mark_dec)
        # x: (B, L, N)
